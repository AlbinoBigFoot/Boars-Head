...
- **Attention** states (FAULT / DEFROST / Operator): saturated accents on StatusIndicator / STS chips only. Manual displays as **Operator**. Device body fill color is reserved for **Comm Loss** only.
