...
PUMP_FACEPLATE_DEFAULTS: dict[str, tuple[str, str]] = {
    ...
    "OCmd_Start": ("false", "Boolean"),
    "OCmd_Stop": ("false", "Boolean"),
    "OCmd_Reset": ("false", "Boolean"),
    "Val_TotRunHrs": ("412.5", "Float"),
    "Val_Starts": ("96", "Int32"),
    "AutoEN": ("true", "Boolean"),
    "Min_Runtime_Set": ("120.0", "Float"),
    "Fail_Timer_PRE": ("30.0", "Float"),
    "Sts_FailToStart": ("false", "Boolean"),
    "Alm_FailToStart": ("false", "Boolean"),
    "Sts_Running": ("true", "Boolean"),
    "Alm_IOFault": ("false", "Boolean"),
    "Interlock/Sts_IntlkOK": ("false", "Boolean"),
    "Interlock/Sts_NBIntlkOK": ("true", "Boolean"),
    "Interlock/Sts_BypActive": ("false", "Boolean"),
    "Interlock/Sts_FirstOut": ("0", "Int32"),
    "Interlock/Sts_Intlk": ("6", "Int32"),
    "Interlock/Cfg_Bypassable": ("7", "Int32"),
    "Interlock/OCmd_Reset": ("false", "Boolean"),
    "Interlock/Rdy_Reset": ("true", "Boolean"),
...
PMP_PROFILES: dict[str, dict[str, str]] = {
    "PMP-01": {
        "Val_Sts": "2",
        "Val_TotRunHrs": "412.5",
        "Sts_FailToStart": "false",
        "Alm_FailToStart": "false",
        "Sts_Running": "true",
        "Alm_IOFault": "false",
        "Sts_Oper": "true",
        "Sts_Maint": "false",
    ...
    "PMP-02": {
        "Val_Sts": "1",
        "Val_TotRunHrs": "realistic(280.0, 5.0, 0.05, 0.2, true)",
        "Sts_Running": "false",
    },
    "PMP-03": {
        "Val_Sts": "1",
        "Val_TotRunHrs": "realistic(190.0, 4.0, 0.06, 0.22, true)",
        "Sts_FailToStart": "true",
        "Alm_FailToStart": "true",
        "Sts_Running": "false",
    },
    "PMP-04": {
        "Val_Sts": "0",
        "Val_TotRunHrs": "realistic(95.0, 3.0, 0.04, 0.18, true)",
        "Sts_Running": "false",
    },
}
# --- END PUMP ---
